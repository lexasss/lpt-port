...
namespace LptPortState
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void UpdatePins()
        {
            ...
            _pins[14].Visibility = _port.S3 ? Visibility.Visible : Visibility.Hidden;
            _pins[12].Visibility = _port.S4 ? Visibility.Visible : Visibility.Hidden;
            _pins[11].Visibility = _port.S5 ? Visibility.Visible : Visibility.Hidden;
            _pins[9].Visibility = _port.S6 ? Visibility.Visible : Visibility.Hidden;
            _pins[10].Visibility = _port.S7 ? Visibility.Visible : Visibility.Hidden;
            _pins[0].Visibility = _port.C0 ? Visibility.Visible : Visibility.Hidden;
            _pins[13].Visibility = _port.C1 ? Visibility.Visible : Visibility.Hidden;
            _pins[15].Visibility = _port.C2 ? Visibility.Visible : Visibility.Hidden;
            _pins[16].Visibility = _port.C3 ? Visibility.Visible : Visibility.Hidden;
        }
